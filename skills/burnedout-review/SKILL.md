...
4. If the PR description or ticket lists items (rules, types, endpoints), check each against the resulting code; an item neither implemented nor marked as rejected is the top finding.
